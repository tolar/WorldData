...
public class CountriesService {
    ...
    static {
        ...
        countryNamesByIso2.put("CI", new CountryNames("Pobřeží slonoviny", "科特迪瓦"));
        ...
        countryNamesByIso2.put("AT", new CountryNames("Rakousko", "奥地利"));
        ...
        countryNamesByIso2.put("CF", new CountryNames("Středoafrická republika", "中非"));
        ...
        countryNamesByIso2.put("BL", new CountryNames("Svatý Bartoloměj", "圣巴泰勒米岛"));
        ...
        countryNamesByIso2.put("CH", new CountryNames("Švýcarsko", "瑞士"));
        ...
        countryNamesByIso2.put("CX", new CountryNames("Vánoční ostrov", "圣诞岛"));
